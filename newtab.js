...
function addSpeedDial(name, link, intCount){
	...
	var thumbnail = "http://chromeutils.appspot.com/t/?url=" + escape(link);
	//the strTopSites variable is continued from the very top of this file
	strTopSites+='<td><div class="speedDialLink">';
	strTopSites+='<a href="'+link+'" id="a' + intCount + '">';
	strTopSites+='<img id="img" class=speedDialLink" src="/appsFromDeveloper/b128.png" alt="' + thumbnail + '" 	width="150px"  height="150px"/>';
	strTopSites+='</a></br><div class="sdname">'+name+'</div></div></td>';
}
